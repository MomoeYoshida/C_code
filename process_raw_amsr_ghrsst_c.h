 ...
 * NAME: 
 *
 *    process_raw_amsr_ghrsst_c
 *
 * FUNCTION:
 *
 *    Header for process_raw_amsr_ghrsst_c.c
 *
 * TYPE/LANGUAGE: 
 *
 *    C header
...
#ifndef PROCESS_RAW_AMSR_GHRSST_HEADER
...
/* external routine */
VINT process_raw_amsr_ghrsst_c( const char *amsr_name, const VINT year, const VINT day, 
...
#define PROCESS_RAW_AMSR_GHRSST_HEADER 1
#endif
